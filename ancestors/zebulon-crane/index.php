...
<meta charset="UTF-8" />
<title>Zebulon Crane b. 1753 - d. 1828 | Crain Ancestry</title>
...
<nav class="paging"> <a href="/ancestry/ancestors/lemuel-crane/" class="previous">previous</a> <a href="/ancestry/ancestors/ebenezer-crain/" class="next">next</a> </nav>
<div class="wrapper clearfix">
  <header>
    <h1>Zebulon Crane</h1>
    <h2>1753 - 1828</h2>
  </header>
  <p><i>Zebulon Crane</i> was born February 21, 1753.  He and Rhoda Thompson, both of Alstead, New Hampshire; were married on November 27, 1777, by a Justice of the Peace. Rhoda&rsquo;s maiden name, Thompson, suggests a English or Scottish origin. According to Revolutionary War pension documents they had 5 children: Thedosia, Ebenezer, Eunice, Elijah and Nabby. E. B. Crane indicates one child, Tryphena, died at two years of age. </p>
  <!--<aside>
    	This is an aside for notes and information on this website. This is an aside for notes and information on this website.
    </aside> -->
  <p>Zebulon served in the Revolutionary War and later received a pension through the Revolutionary War Pension Act of 1818. He first enlisted as a Corporal in November or December of 1775 in Captain Jason Waits Company, <a href="http://en.wikipedia.org/wiki/Bedel's_Regiment">Colonel Bedel&rsquo;s Regiment</a> in the New Hampshire line. </p>
  <p>In February 1776 his corps traveled to Quebec  and by April occupied a strategic position at <em>The Cedars</em>. On May 18 he fought in the <a href="http://en.wikipedia.org/wiki/Battle_of_The_Cedars">Battle of The Cedars</a> where he killed an Iroqois who had severely injured him with a tomahawk. His regiment was captured on May 19 by the British; and later released to the commander of his garrison, Brigadier General <a href="http://en.wikipedia.org/wiki/Benedict_Arnold">Benedict Arnold</a> at Fort Anne on May 30. Bedel&rsquo;s Regiment was disbanded on January 1, 1777, when enlistments expired. Zebulon was discharged on that date, one year from his enlistment at <a href="http://en.wikipedia.org/wiki/Mount_Independence_(Vermont)">Mount Independence</a> by <a href="http://en.wikipedia.org/wiki/Horatio_Gates">General Horatio Gates</a>. </p>
  <p>Zebulon enlisted again, this time as a volunteer and a Sergeant in <a href="http://en.wikipedia.org/wiki/Bellow's_Regiment_of_Militia">Colonel Benjamin Bellow&rsquo;s regiment</a>, again with Captain Jason Wait&rsquo;s Company.    The regiment served in <a href="http://en.wikipedia.org/wiki/William_Whipple">General  William Whipple's</a> brigade of the New Hampshire militia. He served at <a href='http://en.wikipedia.org/wiki/Fort_Ticonderoga'>Fort Ticonderoga</a> in the spring of 1777. </p>
  <p>On September 21, 1777, Bellow&rsquo;s Regiment of Militia also known as the 16th New Hampshire Militia Regiment was called up at Walpole, New Hampshire;  as reinforcements for the Continental Army during the Saratoga Campaign.     The regiment marched quickly to join the gathering forces of General  Gates as he faced British General <a href="http://en.wikipedia.org/wiki/John_Burgoyne">John Burgoyne</a> in northern New York. </p>
...
<cite>The Department of Veterans Affairs. Revolutionary War Pension and Bounty—Land—Warrant Application Files. (Rolls 601-800). Page 5.</cite>
...
<cite>The Department of Veterans Affairs. Revolutionary War Pension and Bounty—Land—Warrant Application Files. (Rolls 601-800). Page 21.</cite>
<blockquote>
...
<cite>The Department of Veterans Affairs. Revolutionary War Pension and Bounty—Land—Warrant Application Files. (Rolls 601-800). Page 6.</cite>
...
<cite>The Department of Veterans Affairs. Revolutionary War Pension and Bounty—Land—Warrant Application Files. (Rolls 601-800). Page 4. </cite>
</div>
</section>
...
<script type="text/javascript">
	...
	var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 7,
      center: new google.maps.LatLng(44.05, -73.3875),
...
//Points of Interest
  ...
  //Fort Ticonderoga
	var fortTiconderogaLatLng = new google.maps.LatLng(43.841667, -73.3875);
  	var fortTiconderogaMarker = new google.maps.Marker({
      position: fortTiconderogaLatLng,
      map: map,
      icon: smPoint
  });
  
   //Battle of Saratoga
	var battleOfSaratogaLatLng = new google.maps.LatLng(42.998889, -73.6375);
  	var battleOfSaratogaMarker = new google.maps.Marker({
      position: battleOfSaratogaLatLng,
      map: map,
      icon: smPoint
  });
  
  //Williamstown, Vermont
	var williamstownVtLatLng = new google.maps.LatLng(44.116111, -72.540833);
  	var williamstownVtMarker = new google.maps.Marker({
      position: williamstownVtLatLng,
      map: map,
      icon: smPoint
  });
  
  // Clarendon, Vermont
  var clarendonVtLatLng = new google.maps.LatLng(43.533333, -72.966667);
  var clarendonVtMarker = new google.maps.Marker({
      position: clarendonVtLatLng,
      map: map,
      icon: smPoint
  });
  
  // Brookfield, Vermont
  var brookfieldVtLatLng = new google.maps.LatLng(44.023611, -72.6);
  var brookfieldVtMarker = new google.maps.Marker({
      position: brookfieldVtLatLng,
      map: map,
      icon: smPoint
  });
  
  // Mount Independence, Vermont
  var mtIndependenceVtLatLng = new google.maps.LatLng(43.826389, -73.380278);
  var mtIndependenceVtMarker = new google.maps.Marker({
      position: mtIndependenceVtLatLng,
      map: map,
      icon: smPoint
  });
  
  // Alstead, NH
  var alsteadNHLatLng = new google.maps.LatLng(43.148889, -72.360556);
  var alsteadNHMarker = new google.maps.Marker({
      position: alsteadNHLatLng,
      map: map,
      icon: smPoint
  });
  
  // Battle of The Cedars
  var theCedarsLatLng = new google.maps.LatLng(45.30993, -74.035336);
  var theCedarsMarker = new google.maps.Marker({
      position: theCedarsLatLng,
      map: map,
      icon: smPoint
  });
...
function showFortTiconderoga(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Fort_Ticonderoga'>Fort Ticonderoga</a></b><br /> June 9, 1777<br />Reported as serving 1 month and 3 days";
    contentString += "";
...
function showBattleOfSaratoga(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Battles_of_Saratoga#Second_Saratoga:_Battle_of_Bemis_Heights_.28October_7.29'>Battle of Saratoga</a></b><br />Second Saratoga: Battle of Bemis Heights<br />(October 7)<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showWilliamstownVt(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Williamstown,_Vermont'>Williamstown, Vermont</a></b><br />Known residence (Crane, Ellery Bicknell)<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showClarendonVt(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Williamstown,_Vermont'>Clarendon, Vermont</a></b><br />Last known residence<br>Home of Orin Hewitt<br> (1840 Census)<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showBrookfieldVt(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Brookfield,_Vermont'>Brookfield, Vermont</a></b><br />Known residence<br>1818-1820<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showMtIndependenceVt(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Mount_Independence_(Vermont)'>Mount Independence, Vermont</a></b><br />Discharged by General Gates<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showAlsteadNH(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Alstead,_New_Hampshire'>Alstead, New Hampshire</a></b><br />Zebulon and Rhoda married<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showTheCedars(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Battle_of_The_Cedars'>The Battle of The Cedars</a></b><br />Fought in the battle and injured by an Iroquois<br />";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
google.maps.event.addListener(fortTiconderogaMarker, 'click', showFortTiconderoga);
google.maps.event.addListener(battleOfSaratogaMarker, 'click', showBattleOfSaratoga);
google.maps.event.addListener(williamstownVtMarker, 'click', showWilliamstownVt);
google.maps.event.addListener(clarendonVtMarker, 'click', showClarendonVt);
google.maps.event.addListener(brookfieldVtMarker, 'click', showBrookfieldVt);
google.maps.event.addListener(mtIndependenceVtMarker, 'click', showMtIndependenceVt);
google.maps.event.addListener(alsteadNHMarker, 'click', showAlsteadNH);
google.maps.event.addListener(theCedarsMarker, 'click', showTheCedars);
