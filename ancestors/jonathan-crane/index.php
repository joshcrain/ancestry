...
<meta charset="UTF-8" />
<title>Jonathan Crane b. 1658 - d. 1735 | Crain Ancestry</title>
...
<section class="clearfix">
  <nav class="paging"> <a href="/ancestry/ancestors/benjamin-crane/" class="previous">previous</a> <a href="/ancestry/ancestors/john-crane/" class="next">next</a> </nav>
  <div class="wrapper clearfix">
    <header>
      <h1>Jonathan Crane</h1>
      <h2>1658 - 1735</h2>
    ...
    <figure><img src="/ancestry/images/jonathan-crane/jonathan-crane-lebanon-ct.jpg" alt="Jonathan Crane, Trumbull Cemetery, Lebanon, Connecticut">
    ...
    <figure><img src="/ancestry/images/jonathan-crane/trumbull-cemetery-lebanon-ct.jpg" alt="Trumbull Cemetery, Lebanon, Connecticut. Photo credit: Karen Carlini (KC) - Find A Grave">
...
<div class="wrapper">
    ...
    <p>Chosen &quot;Ensign in Train Band of Windham.&quot; May, 1695. Commissioned, Oct. 16, 1695 ; made Lieutenant, Oct., 1703.<sup>6</sup></p>
    ...
    <p>January 30, 1700, lie, with Rev. Samuel Whiting, purchased the front portion of William Backus lot, 8 by 20 rods square, and gave it to the town for a &quot;meeting house plot or common;&quot; later this wns called Windham Green and the first church erected on it.</p>
    <p>Chosen, Oct., 1701. on conmhttee to run down lines: Oct. 20, 1702, on committee to see to completing the meeting house; 1703 commissioned Lieutenant by General Court; 1704, Indian War breaking out again, chosen lieutenant: John Fitch, captain. In 1705 Mr. Crane was one of a committee to have charge of all town lands, call meetings, sign acts; made Deacon, also Treasurer of fund of new church; 1726 chosen one of the &quot;seven pillars or councillors of the church.&quot;<sup>8</sup></p>
    <p>CHILDREN<br>
...
<h3>Sources</h3>
	...
	var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 8,
      center: new google.maps.LatLng(41.631366,-72.241446),
...
//Norwich, Connecticut 
	var norwichLatLng = new google.maps.LatLng(41.550131,-72.087059);
  	var norwichMarker = new google.maps.Marker({
      position: norwichLatLng,
      map: map,
      icon: smPoint
  });
  
//New Lebanon, Connecticut 
	var lebanonLatLng = new google.maps.LatLng(41.631366,-72.241446);
  	var lebanonMarker = new google.maps.Marker({
      position: lebanonLatLng,
      map: map,
      icon: smPoint
  });
  
  //Trumbull Cemetery New Lebanon, Connecticut 
	var trumbullLatLng = new google.maps.LatLng(41.643684,-72.203339);
  	var trumbullMarker = new google.maps.Marker({
      position: trumbullLatLng,
      map: map,
      icon: smPoint
  });
   
//Windham, Connecticut 
	var windhamLatLng = new google.maps.LatLng(41.716667,-72.166667);
  	var windhamMarker = new google.maps.Marker({
      position: windhamLatLng,
      map: map,
      icon: smPoint
  });
...
function showNorwich(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Norwich,_Connecticut'>Norwich, Connecticut</a></b><br />Jonathan Crane<br />Marriage";
    contentString += "";
...
function showLebanon(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Lebanon,_Connecticut'>Lebanon, Connecticut</a></b><br />Jonathan Crane<br />Lived here in later years<br>Buried in Lebanon, Connecticut";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showTrumbull(event) {
    var contentString = "<b>Trumbull Cemetery. Lebanon, Connecticut</b><br />Burial Location: Jonathan Crane<br>The Trumbull Cemetery is 0.75 mile east of the junction of Routes 87 and 207.";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
function showWindham(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Windham,_Connecticut'>Windham, Connecticut</a></b><br />Jonathan Crane<br />Built a Sawmill<br />Petitioned the General Court to grant a town charter<br />Among the earliest leaders of Windham";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
google.maps.event.addListener(norwichMarker, 'click', showNorwich);
google.maps.event.addListener(lebanonMarker, 'click', showLebanon);
google.maps.event.addListener(trumbullMarker, 'click', showTrumbull);
google.maps.event.addListener(windhamMarker, 'click', showWindham);
