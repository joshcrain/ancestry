...
<meta charset="UTF-8" />
<title>Benjamin Crane b. abt. 1630 - d. 1691 | Crain Ancestry</title>
...
<section class="clearfix">
  <nav class="paging"> <a href="/ancestry/ancestors/john-crane-england/" class="previous">previous</a> <a href="/ancestry/ancestors/jonathan-crane/" class="next">next</a> </nav>
  <div class="wrapper clearfix">
    <header>
      <h1>Benjamin Crane</h1>
      <h2>abt. 1630 - 1691</h2>
...
<sup>4</sup>Family Records. Windham Records.</p>
    ...
    <cite>Nash, Elizabeth Todd. <em>Fifty Puritan Ancestors, 1628-1660: Genealogical Notes, 1560-1900.</em> New Haven: Tuttle, Morehouse & Taylor Company, 1902. Internet Archive. Web. 2014. Page 93.</cite></div>
    </section>
     <div id="map" class="map_canvas"></div>
    <footer>
<div class="wrapper"><h3>Sources</h3>
      <ul>
...
<script type="text/javascript">
	...
	var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 8,
      center: new google.maps.LatLng(41.701262,-72.669428),
...
//Points of Interest
   ...
   //Wethersfield, Connecticut 
	var wethersfieldLatLng = new google.maps.LatLng(41.701262,-72.669428);
  	var wethersfieldMarker = new google.maps.Marker({
      position: wethersfieldLatLng,
      map: map,
      icon: smPoint
  });
...
function showWethersfield(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Wethersfield,_Connecticut'>Wethersfield, Connecticut</a></b><br />Benjamin Crane<br />";
    contentString += "";
...
google.maps.event.addListener(wethersfieldMarker, 'click', showWethersfield);
