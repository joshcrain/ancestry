...
<meta charset="UTF-8" />
<title>Lemuel Crane b. 1725 - ? | Crain Ancestry</title>
...
<section class="clearfix">
  <nav class="paging"> <a href="/ancestry/ancestors/john-crane/" class="previous">previous</a> <a href="/ancestry/ancestors/zebulon-crane/" class="next">next</a> </nav>
  <div class="wrapper clearfix">
    ...
    <figure>
    <img src="/ancestry/images/lemuel-crane/slade-cemetery-alstead-nh.jpg" alt="Slade Cemetery, Alstead New Hampshire">
...
<div class="wrapper">
    ...
    <blockquote>
      <p>Aug. 2, 1776, Nathaniel Rust conveyed one-fourth of an acre of land for twenty shillings to John Burroughs, John Slade, Lemuel Crane, Job Thompson, John Hill, John Burroughs, Jr., Joel Burroughs, Timothy Burroughs, Daniel Burroughs, John Slade, Jr., and Nathaniel Rust &quot;on the road from Alstead to Marlow at the corner of the fence westerly of my dwelling house.&quot; Although it was not so stated in the deed, yet the names of the grantees, all of whom resided in the southwest corner of Alstead, and the description of the location indicate that this was the piece of land called in this book the &quot;John Slade cemetery.&quot; (Peck, p. 79)<br>
      </p>
      </blockquote>
      ...
      <blockquote>
      <p>The location of the highway has since been changed, so that the cemetery can now be reached only by crossing fields. It is enclosed by a stone wall and was put in order by the town of Alstead several years since. The earliest of the 33 inscriptions is dated April 4, 1785. Arnold refers to this cemetery on page 21 of his &quot;sermon.&quot; After referring to the burial of a child in the burying ground near the middle of the town, he says:</p>
...
//Coventry, Connecticut 
	var coventryLatLng = new google.maps.LatLng(41.784444,-72.338889);
  	var coventryMarker = new google.maps.Marker({
      position: coventryLatLng,
      map: map,
      icon: smPoint
  }); 
...
function showCoventry(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Coventry,_Connecticut'>Coventry, Connecticut</a></b><br />Lemuel Crane<br />Location of Birth";
    contentString += "";
...
function showLebanon(event) {
    var contentString = "<b><a href='http://en.wikipedia.org/wiki/Lebanon,_Connecticut'>Lebanon, Connecticut</a></b><br />Married Jershua Crane<br>Settled in Lebanon, Connecticut.";
    contentString += "";
    infowindow.setContent(contentString);
    infowindow.setPosition(event.latLng);
    infowindow.open(map); 
...
google.maps.event.addListener(coventryMarker, 'click', showCoventry);
